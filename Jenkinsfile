...
" || true
            ...
            post {
                always {
                    archiveArtifacts artifacts: 'pip_audit_report.json', allowEmptyArchive: true
                }
            }
        }
...
''',
                    ...
                    if (criticalFixable > 0) {
                        error "SECURITY GATE FAILED: ${criticalFixable} critical CVEs fixable."
                    }

                    if (env.CURRENT_BRANCH == 'main' && highFixable > 0) {
                        error "SECURITY GATE FAILED: ${highFixable} HIGH CVEs fixable."
                    }
            ...
            steps {
                ...
                withCredentials([file(credentialsId: 'realtimerx-env', variable: 'ENV_FILE')]) {
                    ...
                    sh '''
                        ...
                        echo "Waiting for production app..."
